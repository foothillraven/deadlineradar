...
its own. `data/cpe_hours.json` is inlined into the public CPE pages at
build time by generate.py, entirely client-side/static -- there is no
Worker-side runtime path this could gate even if it wanted to (unlike
